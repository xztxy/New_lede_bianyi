...
# sed -i 's/Variable1 = "*.*"/Variable1 = "Momo"/g' package/lean/luci-app-gpsysupgrade/luasrc/model/cbi/gpsysupgrade/sysupgrade.lua
# sed -i 's/Variable2 = "*.*"/Variable2 = "Momo"/g' package/lean/luci-app-gpsysupgrade/luasrc/model/cbi/gpsysupgrade/sysupgrade.lua
...
# sed -i 's/Variable1 = "*.*"/Variable1 = "Momo"/g' package/lean/luci-app-gpsysupgrade/root/usr/bin/upgrade.lua
# sed -i 's/Variable2 = "*.*"/Variable2 = "Momo"/g' package/lean/luci-app-gpsysupgrade/root/usr/bin/upgrade.lua
